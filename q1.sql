...
BEGIN
    DECLARE cond INT DEFAULT FALSE;
    DECLARE nameHolder VARCHAR(100);
    ...
    loop_through_subs: LOOP
        FETCH sub_cursor INTO nameHolder;
        IF cond THEN
            LEAVE loop_through_subs;
        END IF;

        -- Display subscriber name
        SELECT nameHolder AS Subscriber;
    END LOOP;
